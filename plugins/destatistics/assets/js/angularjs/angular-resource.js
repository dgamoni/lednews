 ...
 *        ...}
	 ...
	 *     and `JSONP`.
	 *   - **`params`** вЂ“ {Object=} вЂ“ Optional set of pre-bound parameters for this action. If any of the
	 *     parameter value is a function, it will be executed every time when a param value needs to be
	 *     obtained for a request (unless the param was overridden).
	 *   - **`url`** вЂ“ {string} вЂ“ action specific `url` override. The url templating is supported just like
