<?php
add_action( 'widgets_init', 'de_toppop_sidebar_widget' );

function de_toppop_sidebar_widget() {
	register_widget( 'toppop_sidebar_widget' );
}

class toppop_sidebar_widget extends WP_Widget {

	
	function toppop_sidebar_widget() {

		$widget_ops = array( 'classname' => 'toppop_sidebar_widget', 'description' => 'DePostrating: Популярное' );

		$this->WP_Widget( 'toppop_sidebar_widget', 'DePostrating: Популярное', $widget_ops );
	}
	...
	function widget( $args, $state ) {
        ...
        echo '<ul class="depostrating-toppop-posts">';
