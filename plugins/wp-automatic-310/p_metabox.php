...
$allowed_tags['Pinterest'] = array(array('[pin_id]','Numerical id of the posted pin'),array('[pin_url]','Pin link to pinterest'),array('[pin_title]','Title of the pin'),array('[pin_description]','Description of the pin'),array('[pin_board_id]','Numeric ID of the board the pin belons to'),array('[pin_board_url]','URL of the matching board'),array('[pin_board_name]','Name of the board the pin belons to'),array('[pin_pinner_username]','Username of the pinner'),array('[pin_pinner_full_name]','Full name of the pinner'),array('[pin_pinner_id]','Numeric ID of the pin pinner'),array('[pin_domain]','Domain for the pin if posted from a url'),array('[pin_likes]','Number of likes of the pin'),array('[repin_count]','Number of repins'),array('[pin_img]','Image src link for the pin image'),array('[pin_img_width]','Width of the pin image'),array('[pin_img_height]','Height of the pin image'),$ad1,$ad2,$source); 
...
<div class="panes">
	...
	<input type="hidden" value="<?php echo $post_id ?>" id="wp_automatic_post_id" />
		...
		<div id="field-camp_type-container" class="field f_100" style="margin-top:10px" >
          ...
          <div  id="field111-container" class="field typepart Articles Amazon Clickbank Youtube Vimeo Flicker  eBay f_100 Pinterest" style="display:none;" >
               <label for="field111">
          ...
          <div id="field5-container" class="field f_100 ">
               ...
               <input value="<?php echo $camp_post_every   ?>" max="100000" min="0" name="camp_post_every" id="field1" required="required" class="ttw-range range"
               type="range">
          </div>
		...
		<!-- Feed part -->
		 ...
		 <div id="yt_date_div" class="typepart Youtube Feeds field f_100">
               <div class="option clearfix">
                    ...
                    <span class="option-title">
							Execlude Item if it is older than a specific date  
                    </span>
                    <br>
...
//echo $post_type.'<br>';			
		...
		<div id="limit_title" class="field f_100">
         ...
         <div id="field1zz-container" class="field f_100">
               <div class="option clearfix">
                    <input data-controls="strip_inline_links" name="camp_options[]" id="field2-1" value="OPT_STRIP" type="checkbox">
                    <span class="option-title">
							Strip original links from the post (hyperlinks) 
                    </span>
                    <br>
                    
                    <div id="strip_inline_links" class="field f_100">
                    
                    	<input name="camp_options[]" value="OPT_STRIP_INLINE" type="checkbox">
	                    <span class="option-title">
								Strip <abbr title="the links that are displayed as-is in the content like http://example.com">inline links</abbr> from the post content (http://example.com) 
	                    </span>
         ...
         <div id="field1zzx-container" class="field f_100">
               <div class="option clearfix">
                    ...
                    <br>
		                ...
		                <div class="option clearfix">
		                    <input  name="camp_options[]"  value="OPT_THUMB_WIDTH_CHECK" type="checkbox">
		                    <span class="option-title">
									Check image width and skip images with width below 100px   
		                    </span>
	                    </div>
		 ...
		 <div id="translate_post" class="field f_100">
               <div class="option clearfix">
                    ...
                    <?php 
                    	...
                    	$langs_c=array("no","af","sq","ar","be","bg","ca","zh-CN","hr","cs","da","nl","en","et","tl","fi","fr","gl","de","el","iw","hi","hu","is","id","ga","it","ja","ko","lv","lt","mk","ms","mt","no","fa","pl","pt","ro","ru","sr","sk","sl","es","sw","sv","th","tr","uk","vi","cy","yi");
                    ?>
...
foreach($camp_post_custom_k as $k){
	...
	?>
		                <div  class="custom_field_wrap">Field Name <input style="width:100px" value="<?php echo $k ?>" name="camp_post_custom_k[]" class="no-unify"> 
		                 value <input style="width:200px" value="<?php echo $camp_post_custom_v[$in] ;?>" name="camp_post_custom_v[]" class="no-unify"><br>   </div>
...
<br><a href="[pin_url]">Source</a> by <a href="https://pinterest.com/[pin_pinner_username]">[pin_pinner_username]</a>
		...
		<?php 
		 ...
		 if(null !==  PARENT_THEME   && PARENT_THEME =='truemag'){
		 	$player ='';
		 	$vmplayer = '';
		 }else{
		 	$player= "[vid_player]
