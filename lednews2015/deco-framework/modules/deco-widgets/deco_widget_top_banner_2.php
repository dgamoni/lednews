...
class Deco_Widget_Top_Banner2 extends WP_Widget {

	/** constructor */
	function __construct() {

		parent::WP_Widget( false, $name = __( 'Правый-баннер 2', TEXTDOMAIN ) );
	...
	function widget( $args, $instance ) {
		...
		<div class="widget side-banner">
			<?php if ( $content ) { ?>
				<?php echo $content; ?>
			<?php } else { ?>
				<img src="<?php echo DECO_THEME_URL; ?>images/banner_300_500_2.png" alt="" />
			<?php } ?>
		</div>
		<?php
	}
...
add_action( 'widgets_init', create_function( '', 'return register_widget("Deco_Widget_Top_Banner2");' ) );