...
//        wp_enqueue_script('acf_qtranslate_main', plugins_url('/assets/main.js', __FILE__));
		...
		wp_register_script( 'acf_qtranslate_main', apply_filters( 'acf/helpers/get_dir', __FILE__ ) . 'assets/main.js', array( 'acf-input' ), '1.0.1' );

		wp_register_style( 'acf_qtranslate_main', apply_filters( 'acf/helpers/get_dir', __FILE__ ) . 'assets/main.css', array( 'acf-input' ), '1.0.1' );
